\begin{frame}{What is the problem?}{Motivation}
    \begin{center}
        \begin{tikzpicture}[scale = 1.5]
            ...
            \node<2> at (5.0,0.0) {\Large{$1$}};
            \node<3-4> at (5.0,0.0) {\Large{$0$}};
            ...
            % Multiple Bits
            \node<5> at (1.5,0.0) {\Large{$0$}};
            \node<5> at (2.5,0.0) {\Large{$1$}};
            \node<5> at (3.5,0.0) {\Large{$1$}};
            \node<5> at (4.5,0.0) {\Large{$0$}};
            \node<5> at (5.5,0.0) {\Large{$1$}};
            \node<5> at (6.5,0.0) {\Large{$0$}};
            \node<5> at (7.5,0.0) {\Large{$1$}};
            \node<5> at (8.5,0.0) {\Large{$0$}};

            \node<6-> at (1.5,0.0) {\Large{$1$}};
            \node<6-> at (2.5,0.0) {\Large{$1$}};
            \node<6-> at (3.5,0.0) {\Large{$0$}};
            \node<6-> at (4.5,0.0) {\Large{$1$}};
            \node<6-> at (5.5,0.0) {\Large{$0$}};
            \node<6-> at (6.5,0.0) {\Large{$0$}};
            \node<6-> at (7.5,0.0) {\Large{$0$}};
            \node<6-> at (8.5,0.0) {\Large{$1$}};
